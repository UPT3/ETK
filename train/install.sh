...
pip install -I https://github.com/MattShannon/bandmat/archive/master.zip wheel numpy==1.22.4 cython==0.29.27 optuna "hydra-core >= 1.1.0, < 1.2.0" "hydra_colorlog >= 1.1.0" hydra-optuna-sweeper mlflow utaupy tqdm pydub pyyaml natsort github-clone tbb gdown "joblib==1.2.0" torch torchvision torchaudio --extra-index-url https://download.pytorch.org/whl/cu113 &> /dev/null
echo "Finished"
